...
export default class DisplaySettings extends Component {
     ...
     */
    componentDidMount() {
        const visualizationElement = this.context.visualizationElements.find((visualizationElement: VisualizationElement) => visualizationElement.Name === this.context.applicationState.selectedElement)
    ...
    render() {
        ...
        return <>
            ...
            {
                !!visualizationElement && !!visualizationElement.Plane ?
                    <div>Gibts schon!</div>
                    : <div>Please place the screen by clicking on the middle of the plane where the screen should appear</div>
            }
            Display Settings
        </>
    }
